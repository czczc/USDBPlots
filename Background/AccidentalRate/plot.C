...
void plot(const char* type = "eps")
{
  ...
  TFile f1("acc_rate.root");
  TGraphErrors *g1 = (TGraphErrors*)f1.Get("BG_AccRate_EH1-AD1");
  TGraphErrors *g2 = (TGraphErrors*)f1.Get("BG_AccRate_EH1-AD2");
  TGraphErrors *g3 = (TGraphErrors*)f1.Get("BG_AccRate_EH2-AD1");
  TGraphErrors *g4 = (TGraphErrors*)f1.Get("BG_AccRate_EH3-AD1");
  TGraphErrors *g5 = (TGraphErrors*)f1.Get("BG_AccRate_EH3-AD2");
  TGraphErrors *g6 = (TGraphErrors*)f1.Get("BG_AccRate_EH3-AD3");

  int nPoints = g1->GetN();
  TCanvas c1("c1", "c1", 1200, 600);
  TH2F h("h", "", 10000, g1->GetX()[0]-3*86400, g1->GetX()[nPoints-1]+3*86400, 100, 0, 14);
  h.GetXaxis()->SetTimeDisplay(1);
  h.GetXaxis()->SetTimeFormat("%b %d");
  h.GetXaxis()->SetNdivisions(505);
  h.GetXaxis()->SetTimeOffset(8*60*60);
  h.GetYaxis()->SetTitle("Events / Day");
  h.SetTitle("Accidental Background Rate");
  h.Draw();
